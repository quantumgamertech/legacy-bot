...
def build_milestones_embed():
    ...
    for years, role_name in sorted(ROLE_MILESTONES.items()):
        milestone_lines.append(f"**{years} year(s)** → {role_name}")
    ...
    embed.set_footer(text="Quantum Gamer Tech • Milestone System")
    return embed
...
def build_serverstatus_embed(guild, is_server_premium_flag, settings):
    ...
    embed.set_footer(text="Quantum Gamer Tech • Server diagnostics")
    return embed
