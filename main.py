...
def build_invite_embed():
    ...
    if BOT_INVITE_URL == "https://discord.com/oauth2/authorize?client_id=1483943578148405279&permissions=268520448&integration_type=0&scope=bot+applications.commands":
        invite_value = (
